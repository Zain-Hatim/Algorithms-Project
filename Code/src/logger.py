...
class PerformanceLogger:
    def __init__(self, log_file: str = "results/runtime_logs.csv"):
        """
        ...
        try:
            ...
            print(f"Warning: Could not create debug log file at {debug_log}")
    ...
    def _init_csv(self):
        ...
        if not self.csv_path.exists():
            try:
                ...
                print(f"Warning: Could not create log file at {self.csv_path}")
    ...
    def log_trial(self, metrics: Dict[str, Any]):
        ...
        try:
            ...
            print(f"Warning: Could not write to log file at {self.csv_path}")
        ...
        try:
            ...
            print(f"Debug: Trial completed: {metrics}")
